...
import {
  EntityStateModel,
  LoadingState
} from '../../../shared/models/entity-state.model';
...
export type FriendsState = EntityStateModel<Friend>;
...
export const reducer = createReducer(
  initialState,
  on(FriendsTrackerPageActions.enter, (state) => ({
    ...state,
  ...
  on(FriendsTrackerPageActions.addFriend, (state) => ({
    ...state,
    callState: LoadingState.LOADING
  })),
